...
export default function AppShell({ email, children }: { email: string; children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFC] text-[#15171C]">
      <Sidebar open={open} onClose={() => setOpen(false)} pinned={pinned} onTogglePin={togglePin} />
